...
// mbcs
MY7ZPP_FUNC int j7zpp_compress_folder(const std::string& archive, const std::string& folder);
// mbcs
MY7ZPP_FUNC j7zpp_res j7zpp_compress_files(const std::string& archive, 
...
MY7ZPP_FUNC j7zpp_res j7zpp_list_files(const std::string& archive, jfile_info** jfinfo);
...
MY7ZPP_FUNC j7zpp_res j7zpp_extract_some(const std::string& archive, 
